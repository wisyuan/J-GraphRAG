...
\item Two domains (medical/novel); the L4 sample is small (14 questions). The
novel-L4 near-zero anomaly was confirmed to be a judge-protocol artifact
(strict gold matching applied to Creative Generation) and is corrected in
\S\ref{sec:replacement:l4fix}; the residual L4 gap is generation-side
faithfulness, not retrieval.
